...
public class EmotionUtils {
	...
	public static final int EMPTY_MAP_TYPE=0x0002;//
	/**
	 * key-表情文字;
	 * value-表情图片资源
	 */
	...
	public static ArrayMap<Integer,ArrayMap<String, Integer>> ALL_MAP;

	static {
		EMOTION_CLASSIC_MAP = new ArrayMap<>();
		EMPTY_MAP = new ArrayMap<>();
		ALL_MAP=new ArrayMap<>();
		...
		ALL_MAP.put(EMOTION_CLASSIC_TYPE,EMOTION_CLASSIC_MAP);
		ALL_MAP.put(EMPTY_MAP_TYPE,EMPTY_MAP);
